...
@section('content')
    {{ Form::open(['route' => 'admin.categories.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-category','files'=>true]) }}
        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {{Form::select("parent_id",$parent_categories,["class"=>"form-control","id"=>"parent_id"])}}
                    </div><!--col-lg-10-->
                </div><!--form control-->
            </div><!-- /.box-body -->
        </div><!--box-->
