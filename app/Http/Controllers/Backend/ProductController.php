...
class ProductController extends Controller
{
    public function index(){
    	...
    	$products = Product::join("users", "users.id", "=", "products.user_id")->join("categories", "categories.id", "=", "products.category_id");
    	$products = $products->select("products.*", "users.name AS user", "categories.title AS category")->orderBy("products.created_at","ASC")->paginate(2);
    ...
    public function create(){
    	...
    	return view("backend.products.create")->with(array("users"=>$users, "categories"=>$categories));
    }
    ...
    public function edit($id){
        ...
        return view("backend.products.edit")->with(array("product"=>$product, "users"=>$users, "categories"=>$categories));
    }
